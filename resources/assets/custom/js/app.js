  ...
  this.Notifications = (function() {
    ...
    function Notifications(options) {
      ...
      this.container = $(_.template(this.notificationsTemplate, {
        bootstrapPositionClass: (_ref = options.bootstrapPositionClass) != null ? _ref : "col-md-6 col-md-offset-2"
      }));
      this.parent.prepend(this.container);
      this.content = this.container.find("#notes");
    ...
    Notifications.push = function(options) {
      if (Notifications.instance === null) {
        new Notifications({
          container: $("body"),
          bootstrapPositionClass: "col-md-6 col-md-offset-2"
        });
      }
...
(function() {
 ...
 $(function() {
    ...
    if ($("body").hasClass("login")) {
      ...
      new Notifications({
        container: $("body"),
        bootstrapPositionClass: "col-md-9"
      });
    }
